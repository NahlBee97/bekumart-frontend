...
export function ReviewSection({ reviews, isLoading }: props) {
  ...
  return (
    <section className="w-full bg-white rounded-2xl p-4 sm:p-6 shadow-sm shadow-ink/5">
      <h2 className="font-display text-lg font-semibold mb-4 text-ink">Penilaian Produk</h2>
      <div className=" flex flex-col sm:flex-row md:items-start items-center p-2 md:p-6 rounded-2xl bg-mist mb-6">
        <ReviewFilter
      ...
      {reviews.length === 0 ? (
        <div className="border-t border-slate-100 py-6">
          <h2 className="text-center text-lg text-frost-deep font-semibold">
