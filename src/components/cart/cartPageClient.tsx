        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col lg:gap-8">
              {/* Cart Items List */}
              <section aria-labelledby="?-heading" className="lg:col-span-7">
                <ul role="list">
                  {cart?.items.map((item) => (
              ...
              >
                ...
                <div className="mt-4">
                  <button
                    ...
                    disabled={isLoading}
                    className={`w-full flex items-center justify-center font-bold ${ isLoading ? "bg-gray-300" : "bg-blue-500" } border border-transparent rounded-md shadow-sm py-3 px-4 text-base text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-blue-500 transition-transform transform hover:scale-105`}
                  >
                    {isLoading ? (
